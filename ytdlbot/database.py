...
from config import MYSQL_HOST, MYSQL_PASS, MYSQL_USER, MYSQL_PORT, REDIS, IS_BACKUP_BOT
    ...
    def __init__(self):
        try:
            ...
            self.con = pymysql.connect(
                host=MYSQL_HOST, port=MYSQL_PORT, user=MYSQL_USER, passwd=MYSQL_PASS, db="ytdl", charset="utf8mb4"
            )
        except Exception:
